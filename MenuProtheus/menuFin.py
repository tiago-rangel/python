...
ambientes = {
    ...
    ('10.14.115.12', '1299'): '[ 2 ] MyMobility',
    ('10.14.115.30', '1303'): '[ 3 ] Safran Representações',
    ('10.14.115.12', '1304'): '[ 4 ] Ambiente de Validação'
}
...
|       [ 1 ] Padrão                                         |
|       [ 2 ] MyMobility_1299                                |
|       [ 3 ] Safran Representações                          |
|       [ 4 ] Ambiente de Validação                          |
|       [ 5 ] Verificar ambiente                             |
|       [ 6 ] Sair do configurador e Abrir o Protheus        |
|                                                            |
|                                                            |''' + "\033[0m")
    print("\033[32m" + ' _____________________________________________________________' + "\033[0m")
